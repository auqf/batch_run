...
service = [
    ...
    'cd /home/eks;chmod a+x {chiji_dashen,chiji1,chiji2,ffmpeg,clip,lightpush,dynamic_ingest,lightpush.service,clip.service,dynamic_ingest.service, local_video.service}',
    ...
    'cd /home/eks && mv -f {lightpush.service,clip.service,dynamic_ingest.service,local_video.service} /etc/init.d',
